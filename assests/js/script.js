...
// // console.log(datas); //umumi siyahi
// console.log(datas[0]); 0-ci indeksdeki elementi
// console.log(datas[datas.length-1]); sonuncu elementi verir
